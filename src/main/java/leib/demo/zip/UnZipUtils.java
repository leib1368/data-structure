...
/*
*@author Leib
*@date 2021/12/28 11:32 上午
* https://www.cnblogs.com/622698abc/p/3389855.html
*/
public class UnZipUtils {
    public static void main(String[] args) {
        UnZipUtils z = new UnZipUtils();
        String source = "/Users/lixuedan/Desktop/t1.zip";
        String dest = "/Users/lixuedan/Desktop/c1/";
        String fileFolder = "/Users/lixuedan/Desktop/信贷业务信息归档包";

        String password = "";

       z.zip(fileFolder, source, true, "111");
       // z.unZip(source,dest,"111");
    }
